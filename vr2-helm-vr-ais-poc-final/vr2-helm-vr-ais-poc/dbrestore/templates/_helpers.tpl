...
*/}}
{{- define "dbrestore.clusterroletemplate" }}
kind: ClusterRole
...
*/}}
{{- define "dbrestore.serviceaccounttemplate" }}
apiVersion: v1
kind: ServiceAccount
metadata:
    name: "{{ .Values.appName }}-service-role"
...
*/}}
{{- define "dbrestore.rolebindingtemplate" }}
...
*/}}
{{- define "dbrestore.servicetemplate" }}
apiVersion: v1
kind: Service
metadata:
...
*/}}
{{- define "dbrestore.ingresstemplate" }}
{{- with .Values.ingress }}
